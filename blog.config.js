...
const BLOG = {
  ...
  NOTION_PAGE_ID:
    ...
    'bababee02d3949c59d03dd7699c57d33',
  ...
  GREETING_WORDS:
    ...
    'Hi~ I am a PM who loves programming, Welcome to my blog',
  ...
  CONTACT_LINKEDIN: process.env.NEXT_PUBLIC_CONTACT_LINKEDIN || 'https://www.linkedin.com/in/kcccc0711/', // 你的linkedIn 首页
  ...
  RANDOM_IMAGE_REPLACE_TEXT:
    ...
    'https://unsplash.com/photos/crescent-moon-view-during-night-time-0QyCjIiEuq0', // 触发替换图片的 url 关键字(多个支持用英文逗号分开)，只有图片地址中包含此关键字才会替换为上方随机图片url
